...
For Geant4-11 to use CASCADE, it is likely you will have to define the environment variables directly using 'configCASCADE.sh' - the commands are not guaranteed to work. The printout may also say that it isn't using CASCADE when it actually is.
